...
public class Wave : MonoBehaviour {
    ...
    private void Start()
    {
        GameObject newEnemy=FindObjectOfType<FollowThePath>().gameObject;
    ...
    void DrawPath(Transform[] path) //drawing the path in the Editor
    {
        ...
        Road.positionCount = SmoothAmount;
        RoadLine.positionCount = SmoothAmount;
        ...
        {            
            ...
            Road.SetPosition(i-1, new Vector3(currentPositions.x, 0, currentPositions.z) );
            RoadLine.SetPosition(i-1, new Vector3(currentPositions.x, 0, currentPositions.z) );
